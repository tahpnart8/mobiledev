...
/**
 * Vẽ biểu đồ cột (histogram) thể hiện phân bố tần suất của một mảng số
 * nguyên (thường là kết quả trả về từ AStats.freq()).
 *
 * Nếu môi trường chạy có hỗ trợ đồ họa (có màn hình), chương trình sẽ mở
 * một cửa sổ Swing để vẽ biểu đồ. Nếu môi trường không hỗ trợ đồ họa
 * (headless), chương trình sẽ tự động chuyển sang vẽ biểu đồ dạng văn bản
 * ra console.
 */
public class GraphicsA {

    /**
     * Vẽ biểu đồ cột dạng cửa sổ đồ họa (Swing) cho mảng tần suất đầu vào.
     * Nếu môi trường không hỗ trợ đồ họa (headless) thì bỏ qua, không mở
     * được cửa sổ.
     */
    ...
    /**
     * Vẽ biểu đồ cột bằng ký tự văn bản ra console (dùng khi không có
     * môi trường đồ họa, hoặc muốn xem nhanh kết quả trên terminal).
     */
    ...
    /**
     * Panel Swing tự vẽ biểu đồ cột dựa trên mảng tần suất truyền vào.
     */
